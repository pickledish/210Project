...
function playNotes(note1, note2, note3) {
	...
	o1.frequency.value = note1;
	o2.frequency.value = note2;
	o3.frequency.value = note3;
...
$(document).ready(function() {
	...
	$("#play").click(function( event ) {
		...
		var freq2 = noteValues['F5'];
		var freq3 = noteValues['A4'];

		playNotes(freq1, freq2, freq3);

	});

	$("#playRandom").click(function( event ) {

		var freq1 = (Math.random()*900) + 100;
		var freq2 = (Math.random()*900) + 100;
		var freq3 = (Math.random()*900) + 100;
